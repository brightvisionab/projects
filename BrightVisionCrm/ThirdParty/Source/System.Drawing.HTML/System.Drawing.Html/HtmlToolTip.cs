...
namespace System.Drawing.Html
{
        ...
        : ToolTip
    {
        ...
        #endregion
        public void Show(string loadingString, string htmlString, IWin32Window window, Point point)
        {
            HtmlString = htmlString;
            this.Show(loadingString, window, point);
        }
        void HtmlToolTip_Popup(object sender, PopupEventArgs e)
        {
            ...
            container = new InitialContainer("<table class=htmltooltipbackground cellspacing=\"5\" cellpadding=\"0\" style=\"min-width:200px;" + font + "\"><tr><td style=\"border:0px\">" + HtmlString + "</td></tr></table>");
            //container = new InitialContainer("<div class=\"htmltooltipbackground\" style=\"width:300px;" + font + "\">" + text + "</div>");
