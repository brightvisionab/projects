...
namespace BrightVision.Threading
{
   /// <summary>
   ...
   public class WorkItemEventArgs : EventArgs
   {
      ...
      /// <summary>
      ///   Gets the <see cref="BrightVision.Threading.WorkItem"/> associated with the event.
      /// </summary>
      /// <value>
      ///   The <see cref="BrightVision.Threading.WorkItem"/> that caused the event.
      /// </value>
