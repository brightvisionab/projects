...
namespace SalesConsultant.Modules 
{
    public partial class ViewConfiguration : XtraUserControl 
    {
        ...
        private void m_oReport_AfterSave(object sender, ReportUserDesigner.AfterSaveArgs e)
        {
            if (m_oReport.ModuleType == ReportUserDesigner.eModuleType.ReportTemplate) {
                ...
                if (!string.IsNullOrEmpty(e.efViewConfiguration.report_layout_config)) {
                    ...
                    tbpgeLayoutConfig.Image = SalesConsultant.Properties.Resources.save_ok;
                    btnEditReportTemplate.Image = SalesConsultant.Properties.Resources.view_config_completed;
        ...
        private void _control_AfterSave(CreateBlankView.AfterSaveArgs e)
        {
            ...
            if (m_IsNew) {
                ...
                try {
                    ...
                    //btnShowXmlViewConfig.Enabled = true;
                    m_ConfigGrid.Complete = true;
                    tbpgeGridConfig.Image = SalesConsultant.Properties.Resources.save_ok;
                    IsNewConfig = false;
                    IsSaved = true;
        ...
        private void btnLoadView_Click(object sender, EventArgs e) 
        {
            ...
            tbpgeLayoutConfig.Image = SalesConsultant.Properties.Resources.incomplete_on_edit;
            btnEditReportTemplate.Image = SalesConsultant.Properties.Resources.view_config_incomplete;
            tbpgeParameterConfig.Image = SalesConsultant.Properties.Resources.incomplete_on_edit;
                    ...
                    if (configId > 0) {
                        ...
                        if (m_efoViewConfig != null) {
                            ...
                            if (!string.IsNullOrEmpty(m_efoViewConfig.xml_config)) {
                                ...
                                tbpgeGridConfig.Image = SalesConsultant.Properties.Resources.incomplete_on_edit;
                            ...
                            if (!string.IsNullOrEmpty(m_efoViewConfig.report_data_config)) {
                                ...
                                tbpgeParameterConfig.Image = SalesConsultant.Properties.Resources.save_ok;
                            }
                            else
                                tbpgeParameterConfig.Image = SalesConsultant.Properties.Resources.incomplete_on_edit;
                        }
        ...
        private void btnCancel_Click(object sender, EventArgs e) 
        {
            ...
            this.ReloadSubCampaignList();
            lookUpEditSubcampaign.EditValue = -1;
        ...
        private void tcViewConfig_SelectedPageChanging(object sender, DevExpress.XtraTab.TabPageChangingEventArgs e)
        {
            ...
            if (e.PrevPage.Equals(tbpgeGridConfig) && !m_ConfigGrid.Complete) {
                ...
                BrightVision.Common.UI.NotificationDialog.Warning("Bright Sales", "Please complete grid configuration first.");
                e.Cancel = true;
                return;
            }
                ...
                BrightVision.Common.UI.NotificationDialog.Warning("Bright Sales", "Please complete layout configuration first.");
                e.Cancel = true;
                return;
            }
                ...
                BrightVision.Common.UI.NotificationDialog.Warning("Bright Sales", "Please complete parameter configuration first.");
                e.Cancel = true;
                return;
            }
        }
        ...
        {
            //MessageBox.Show("Sorry, this feature is not yet implemented", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //return;

            if (!m_ConfigGrid.Complete || !m_ConfigLayout.Complete || !m_ConfigParameter.Complete) {
                BrightVision.Common.UI.NotificationDialog.Warning("Bright Sales", "Please kindly complete all configuration first.");
                return;
            }
            else if (m_efoViewConfig == null) {
                BrightVision.Common.UI.NotificationDialog.Warning("Bright Sales", "No selected report.");
                return;
            }

            m_EventBus.Notify(new ReportConfigurationEvents.OnReportPreview() {
                ReportConfigId = m_efoViewConfig.id
            });
